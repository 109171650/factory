...
var _reactTransformHmrLibIndexJs2 = (0, _index3.default)({
  filename: '/data/SimpleApp/node_modules/react-native/Libraries/Lists/VirtualizedList.js',
      ...
      if (itemCount > 0) {
        ...
        if (!disableVirtualization && _first > lastInitialIndex + 1) {
          ...
          if (stickyIndicesFromProps.size > 0) {
            ...
            for (var ii = firstAfterInitial - 1; ii > lastInitialIndex; ii--) {
              if (stickyIndicesFromProps.has(ii + stickyOffset)) {
                ...
                cells.push(React.createElement(View, { key: '$sticky_lead', style: _defineProperty({}, spacerKey, leadSpace) }));
                ...
                cells.push(React.createElement(View, { key: '$sticky_trail', style: _defineProperty({}, spacerKey, trailSpace) }));
          ...
          if (!insertedStickySpacer) {
            ...
            cells.push(React.createElement(View, { key: '$lead_spacer', style: _defineProperty({}, spacerKey, firstSpace) }));
          }
        }
        ...
        if (!disableVirtualization && _last < itemCount - 1) {
          ...
          cells.push(React.createElement(View, { key: '$tail_spacer', style: _defineProperty({}, spacerKey, tailSpacerLength) }));
        }
      }
...
var _initialiseProps = function _initialiseProps() {
  ...
  this._onCellUnmount = function (cellKey) {
    ...
    if (curr) {
      _this4._frames[cellKey] = _extends({}, curr, { inLayout: false });
    }
  };
